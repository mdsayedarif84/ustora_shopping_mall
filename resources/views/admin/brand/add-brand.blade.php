...
@section('body')
    <div class="content-wrapper dark-mode">
        <div class="container">
            <marquee><h3 class="text-success font-weight-bolder">Welcome Back Our Add Brand Page.</h3></marquee>
            <div class="card">
                        ...
                        <div class="card-body">
                            {!! Form::open(['class'=>'user','route'=>'save-brand','method'=>'POST']) !!}
                                ...
                                <div class="form-group">
                                    {!! Form::textarea('brand_description','',['class'=>'form-control','placeholder'=>'BrandDescription','rows'=>'2']); !!}
