                ...
                <div class="card-body">
                    <div class="card">
                        <div class="card-header">
                            <h4 class="text-danger font-weight-bolder"> Edit Product
                                <a href="{!! route('manage-product') !!}" class="btn btn-danger btn-sm float-right">
                                    <i class="far fa-hand-point-right"> </i>Manage Product</a>
                            </h4>
                        </div>
                        <div class="card-body">
                            {!! Form::open(['route'=>'update-product','name'=>'editProductForm', 'method'=>'POST','enctype'=>'multipart/form-data']) !!}
                                ...
                                <div class="form-group">
                                    {!! Form::textarea('short_description',$product->short_description,['class'=>'form-control text-success font-weight-bolder','placeholder'=>'ShortDescription','rows'=>'2']); !!}
                                    <span class="text-danger">{{ $errors->has('short_description') ? $errors->first('short_description') : ' ' }}</span>
                                </div>
                                <div class="form-group">
                                    {!! Form::textarea('long_description',$product->long_description,['id'=>'editor','class'=>'form-control text-success font-weight-bolder','placeholder'=>'LongDescription','rows'=>'2']); !!}
